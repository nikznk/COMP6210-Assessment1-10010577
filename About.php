            ...
            <div class="container">
                <div class="intro">
                    ...
                    <p class="text-center">Paragraph
                        <br>Our customers love us! Read what they have to say below. Aliquam sed justo ligula. Vestibulum nibh
                    ...
                    <div class="col-md-6 col-lg-4 item">
                        <div class="box">
                            <p class="description">Paragraph
                                <br>Aenean tortor est, vulputate quis leo in, vehicula rhoncus lacus. Praesent aliquam in tellus
                                eu gravida. Aliquam varius finibus est
                                <br>
                                <br>
                            </p>
                            <div class="author">
                                <img class="rounded-circle img-fluid" src="http://via.placeholder.com/220x220">
                                <h5 class="text-center">Nikhil kamble</h5>
                                <p class="text-center">Owner of the page</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 item">
