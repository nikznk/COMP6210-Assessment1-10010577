...
<body>
    <section id="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <p class="text-center">
                        <br>s simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                ...
                <div class="col col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <p>
                        <br>It is a long established fact that a reader will be distracted by the readable content of a page
            ...
            <div class="row">
                ...
                <div class="col col-lg-4 col-sm-6 col-12">
                    <h6>Is Lorem Ipsum Useful?</h6>
                    <p>
                        <br>The obvious idea is to start this article off with a description of lorem ipsum and where it came
                        from, but as designers we pretty much all get the idea: it’s filler text.&nbsp;
                        <br>
                    </p>
                </div>
                <div class="col-lg-4  col-sm-6 col-12">
                    <h6>Lorem ipsum loreansbdhajna?</h6>
                    <p>
        ...
        <div class="contact-clean col-lg-12">
            <form class="feedback">
                <h2 class="text-center" style="height:0px;">Rate Our Website</h2>
                <p class="text-center">
