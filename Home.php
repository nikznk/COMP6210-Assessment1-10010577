...
<body>
    <section id="main">
        ...
        <div class="col-md-12">
            ...
            <img src="assets/img/Avengers-banner.jpg" class="img-fluid">
        </div>

        <div class="col-md-12 d-flex justify-content-center align-items-center">
            <input class="form-control-lg" type="search" placeholder="Enter name of movie or tv shows">
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col col-md-4 col-sm-6 col-xs-12">
                    <span class="imdbRatingPlugin" data-user="ur55565964" data-title="tt1431045" data-style="p1">
                        <a href="https://www.imdb.com/title/tt1431045/?ref_=plg_rt_1">
                            <img src="https://ia.media-imdb.com/images/G/01/imdb/plugins/rating/images/imdb_46x22.png" alt=" Deadpool
                    (2016) on IMDb" />
                        </a>
                    </span>
                </div>
